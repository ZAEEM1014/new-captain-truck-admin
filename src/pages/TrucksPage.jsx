...
export const truckTypes = [
  ...
  { value: 'terminal-compliance', label: 'Terminal compliance' },
  { value: 'tractor-service-power-only', label: 'Tractor Service (Power-Only)' },
  { value: 'drop-hook', label: 'Drop & hook' },
  { value: 'temperature-controlled', label: 'Temperature-Controlled' },
  { value: 'sealed-loads-monitoring', label: 'Sealed loads & continuous monitoring' },
  { value: 'stepdeck-flatdeck', label: 'Step Deck & Flatdeck' },
  { value: 'permits-arranged', label: 'Permits arranged' },
  { value: 'dry-van', label: 'Dry Van' },
  { value: 'retail-cpg', label: 'Retail & CPG' },
  { value: 'cross-dock', label: 'Cross Dock' },
  { value: 'short-dwell', label: 'Short dwell' },
...
const TrucksPage = () => {
  ...
  const handleAddTruck = async (e) => {
    ...
    try {
      ...
      setNewTruck(prev => ({
        truckNumber: '',
        plateNumber: '',
        truckType: prev.truckType, // preserve last selected value
        capacity: '',
        status: 'operational',
        make: '',
        model: '',
  ...
  const handleEditTruck = (truck) => {
    setEditTruck({
      ...truck,
      type: truck.truckType, // always use truckType for editing
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p><strong>Type:</strong> {selectedTruck.truckType ? selectedTruck.truckType.replace('-', ' ') : 'N/A'}</p>
