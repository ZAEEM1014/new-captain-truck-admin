                    ...
                    {Object.values(selectedTrip.driverAssignments).map((assignment, index) => {
                      ...
                      return (
                        <div key={assignment.driverId} className="bg-white p-4 rounded border">
                          ...
                          {/* Driver Messages at Start and End of Trip */}
                          {assignment.startMessage && (
                            <div>
                              <p className="font-medium text-gray-600 mb-1">Driver Start Message:</p>
                              <p className="text-sm text-blue-700 italic">"{assignment.startMessage}"</p>
                            </div>
                          )}
                          {assignment.endMessage && (
                            <div>
                              <p className="font-medium text-gray-600 mb-1">Driver End Message:</p>
                              <p className="text-sm text-green-700 italic">"{assignment.endMessage}"</p>
                            </div>
                          )}
                          {assignment.notes && (
                            <div>
